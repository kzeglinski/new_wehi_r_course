...
We covered design matrices in session 6 in very brief detail. They are a very powerful and important component of linear modelling that allow complex experimental designs to answer difficult questions. You can read more about them in the article [A guide to creating design matrices for gene expression experiments](https://f1000research.com/articles/9-1444).
