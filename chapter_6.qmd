...
To download the RNAseq data for this workshop, use the following command

```{r}
#| message: false
#| warning: false
#| eval: false
download.file("https://github.com/Shians/BaseR_Intro/raw/master/data/workshop_data.zip",
