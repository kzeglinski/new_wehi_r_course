...
If you havent yet downloaded the RNAseq data for this workshop, you can download it using the following command

```{r}
download.file("https://github.com/WEHI-Education/BIOL90042_R_Course/blob/main/data/rnaseq_workshop_data.zip", "data/rnaseq_workshop_data.zip")
```

Now to unzip the files data and store in the `data/` directory:
```{r}
