...
colourful_scatterplot <- ggplot(data = m_dose,
  aes(x = initial_weight_g, y = tail_length_mm, colour = mouse_strain)) +
  geom_point() +
  geom_smooth(method = "lm")
...
::: choice
`ggplot2(data = m_dose, aes(x = drug_dose_g, y = weight_lost_g))`
:::
...
```{r}
#| warning: false
tail_cage_boxplot <- ggplot(data = m_dose,
...
tail_weight_scatterplot <- ggplot(data = m_dose,
